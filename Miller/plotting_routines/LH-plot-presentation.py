...
if __name__ == "__main__":
    ...
    AE_list = pool.starmap(AEtok.calc_AE, [(omnv[idx],eta,epsilon,q,kappa,deltav[idx],dR0dr,2 - 2*omnv[idx]/10 ,s_kappa,s_delta, 2 * omnv[idx]/10,theta_res,L_ref) for idx, val in np.ndenumerate(AEv)])
