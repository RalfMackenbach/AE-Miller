...
omn_grid          =  np.linspace(+2.0,+10.0, num=100, dtype='float64')
...
if __name__ == "__main__":
    ...
    AE_list = pool.starmap(AEtok.calc_AE, [(omnv[idx],eta,epsilon,q,kappa,delta,dR0dr,sv[idx],s_kappa,s_delta,alphav[idx],theta_res,lam_res,del_sign) for idx, val in np.ndenumerate(AEv)])
    ...
    hf      = h5py.File("isocontour_eta={}_eps={}_q={}_kappa={}_delta={}_dR0dr={}_skappa={}_sdelta={}.hdf5".format(eta,epsilon,q,kappa,delta,dR0dr,s_kappa,s_delta), "w")
    ...
    fig.write_html("/Users/ralfmackenbach/Documents/GitHub/AE-tok/plots/3d_iso/fig1.html")
