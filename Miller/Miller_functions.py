...
def rdbpdrho(theta,MC):
    return 1/R_s(theta,MC) - MC.alpha/(2*MC.epsilon*bps(theta,MC))*(1/R_s(theta,MC) - R_s(theta,MC)) - MC.sigma/(R_s(theta,MC)*bps(theta,MC))
...
# total field radial derivative r*db_p/drho
