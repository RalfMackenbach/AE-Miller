...
alpha_grid      =  np.linspace(+0.0, +1.0, num=100, dtype='float64')
...
if __name__ == "__main__":
    ...
    fig = plt.figure(figsize=(6.850394, 3.0)) #figsize=(3.375, 2.3)
    ax  = fig.gca()
    ...
    plt.margins(0.1)
    plt.savefig('/Users/ralfmackenbach/Documents/GitHub/AE-tok/plots/Miller_plot_sa_wn={}_eta={}_eps={}_q={}_kappa={}_delta={}_dR0dr={}_skappa={}_sdelta={}.eps'.format(omn,eta,epsilon,q,kappa,delta,dR0dr,s_kappa,s_delta), format='eps',
